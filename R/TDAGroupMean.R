#'Estimate the arithmetic mean of grouped data
#'
#'This is essentially \code{\link{weighted.mean}} for a \code{data.frame}
...
#'calculate the simple arithmetic \code{\link{mean}} from the raw data if that
#'is available
#'@author Ananda Mahto
#'@seealso \code{\link{weighted.mean}}, \code{\link{mean}},
